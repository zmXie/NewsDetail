...
@interface FirstViewController () <UITableViewDelegate,UITableViewDataSource,WTScrollViewDataSource,WKNavigationDelegate>
{
...
- (void)setupNav
{
    ...
    UIBarButtonItem *two = [[UIBarButtonItem alloc]initWithTitle:@"评论" style:UIBarButtonItemStylePlain target:self action:@selector(rightAction:)];
    self.navigationItem.rightBarButtonItems = @[two,one];
}
